package net.ezmovil.betterflyKotlin
...
import net.ezmovil.betterflyKotlin.info.infoACKS
import net.ezmovil.betterflyKotlin.info.infoContext
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //albumList.add(a);
        val task1: MainActivity.apiCharacters =
            MainActivity.apiCharacters()
    ...
    private fun prepareAlbums() {
        ...
        try {
            ...
            for (i in 0 until obj.getJSONArray("results").length()) {
    ...
    private class apiCharacters : Runnable {
        ...
        override fun run() {
            ...
            try {
                response = httpclient.execute(HttpGet("https://rickandmortyapi.com/api/character"))
